    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          console.log(likeData); // const { data } = yield call([axios, 'post'], 'http://127.0.0.1:3001/insertLike', likeData, {
          //   withCredentials: true,
          // });
          // console.log(data);
          // yield put();
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          console.log(unlikeData); // const { data } = yield call([axios, 'post'], 'http://127.0.0.1:3001/deleteLike', unlikeData, {
          //   withCredentials: true,
          // });
          // console.log(data);
          // yield put();
...
//# sourceMappingURL=_app.js.acf07a06a78d19a17a93.hot-update.js.map