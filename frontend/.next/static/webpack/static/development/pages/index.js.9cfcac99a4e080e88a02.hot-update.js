    ...
    case UNLIKE_CARD_SUCCESS:
      {
        ...
        var _cardIndex = state.card.findIndex(function (v) {
          return v.board_id === action.payload.boardId;
        });

        console.log(_cardIndex);

        var likeIndex = state.card[_cardIndex].likes.findIndex(function (v) {
        ...
        _card[_cardIndex].likes = _card[_cardIndex].likes.splice(likeIndex, 1);
        return _objectSpread({}, state, {
          card: _card
        });
      }
...
//# sourceMappingURL=index.js.9cfcac99a4e080e88a02.hot-update.js.map