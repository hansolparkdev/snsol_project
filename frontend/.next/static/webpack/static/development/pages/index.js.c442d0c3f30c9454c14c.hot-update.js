    ...
    case LIKE_CARD_SUCCESS:
      {
        ...
        var cardIndex = _card.findIndex(function (v) {
          return v.board_id === action.payload.board_id;
        });

        _card[cardIndex].likes = _card[cardIndex].likes.concat(action.payload);
        return _objectSpread({}, state, {
          card: _card
        });
      }
    ...
    case UNLIKE_CARD_SUCCESS:
      {
        ...
        var _cardIndex = _card2.findIndex(function (v) {
          return v.board_id === action.payload.boardId;
        });

        var likeIndex = _card2[_cardIndex].likes.findIndex(function (v) {
          return v.user_id === action.payload.userId;
        });

        _card2[_cardIndex].likes.splice(likeIndex, 1);
...
//# sourceMappingURL=index.js.c442d0c3f30c9454c14c.hot-update.js.map