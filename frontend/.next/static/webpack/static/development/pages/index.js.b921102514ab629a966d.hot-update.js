    ...
    case UNLIKE_CARD_SUCCESS:
      {
        ...
        var likeIndex = state.card[_cardIndex].findIndex(function (v) {
          return v.board_id === action.payload.board_id;
        });

        var _card = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_6__["default"])(state.card);

        _card[_cardIndex].likes = _card[_cardIndex].likes.splice(action.payload);
        return _objectSpread({}, state, {
          card: _card
        });
      }
...
//# sourceMappingURL=index.js.b921102514ab629a966d.hot-update.js.map